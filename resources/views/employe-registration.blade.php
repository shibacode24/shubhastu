					...
					<div class="col-md-12 mx-auto" style="margin-top: -10%;">
						<div class="card">
							<div class="card-body">
								...
								<hr>
								<form class="row g-2" method="post" action="{{route('create_employee_register')}}">
									@csrf
									<div class="col-md-2">
										<label for="inputFirstName" class="form-label">Employee Name*</label>
										<input type="text" class="form-control" id="inputFirstName" name="employee_name" placeholder="Employee Name">
									</div>

									<div class="col-md-2">
										<label for="inputFirstName" class="form-label">Contact No.*</label>
										<input type="number" class="form-control" id="inputFirstName" placeholder="Contact No." name="contact_no">
									</div>
