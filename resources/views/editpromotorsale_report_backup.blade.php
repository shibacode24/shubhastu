...
@section('content')
    ...
    <form method="POST" action="{{ route('update-promotorsalereport') }}" id="createpromotor_formid">
                                ...
                                <div class="row g-2">
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <select class="multiple-select companystokist medicaleschme1"
                                            data-placeholder="Choose anything" id="company1" name="company">
                                ...
                                <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleLargeModal2"><i class="fadeIn animated bx bx-plus"></i></button>
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <input type="text" class="form-control" id="" placeholder="scheme"
                                            name="sheme" value="{{ $prosalereportedit->select_scheme }}">
...
@endphp --}}
{{-- @json($stocmed[0]->promotorsalemedicine_id) --}}
                                            <tr> @php
                                            ...
                                            @endphp
                                                <td><input type="hidden" name="id[]"
                                                        ...
                                                        class="form-control " value="{{ $stocmed[0]->select_stokist_id }}"
                                                        name="stockist[]"></td>
                                                        <td><input type="text" readonly class="form-control quantity_class "
                                                            value="{{ $stocmed[0]->promotorsalemedicine_id }}" id="promotorsalemedicine_id" name="promotorsalemedicine_id">
                                                    </td>
                                                <td><input type="text" readonly class="form-control "
                                                        value="{{ $stocmed[0]->select_medical_id }}" name="medical[]">
                                                </td>
                                                <td><input type="text" readonly
                                                        class="form-control filtered_grand_total{{ $stock_name }}"
                                                        value="{{ $stocmed[0]->grandtot1 }}"
                                                        name="grandtot1[]"></td>
                                                <td>
                                                ...
                                                <td><input type="text" readonly class="form-control ptr_class "
                                                        value="{{ $stocmed[0]->ptrs }}" id="ptr1" name="ptr1[]">
                                                </td>
                                                <td><input type="text" readonly class="form-control mps_class"
                                                        value="{{ $stocmed[0]->mpss }}" name="mps1[]"></td>
                                                ...
                                                <td><input readonly type="text"
                                                        ...
                                                        class="form-control total1_class "name="mpsqnty[]"></td>
                                                <td><input readonly type="text"
                                            ...
                                            {{-- <tr>
                                                    <td><input type="text" readonly class="form-control " value="{{$stocmed[0]->select_stokist_id}}" name="stockist[]">
                                                    </td>
                                                    <td><input type="text" readonly class="form-control " value="{{$stocmed[0]->select_medical_id}}" name="medical[]">
                                                    </td>
                                                    <td><input type="text" readonly class="form-control " value="{{$stocmed[0]
                                                                                                    ->grandtot1}}" id="total_count" name="grandtot1[]"></td>
                                                    <td><input type="text" readonly class="form-control " value="{{$stocmed[0]->grandtot2}}" name="grandtot2[]">
                                                
                                                    </td>
                                                    <td><input type="text" readonly class="form-control " value="{{$stocmed[0]->select_medicine1}}" name="medicine[]">
                                                    </td>
                                                    <td><input type="text" readonly class="form-control " value="{{$stocmed[0]->select_batchs}}" name="batch[]"></td>
                                                    <td><input type="text" readonly class="form-control ptr_class " value="{{$stocmed[0]->ptrs}}"
                                                            id="ptr1{{$loop->index}}" name="ptr1[]"></td>
                                                    <td><input type="text" readonly class="form-control mps_class" value="{{$stocmed[0]->mpss}}" name="mps1[]"
                                                            id="mps1{{$loop->index}}"></td>
                                                    <td><input type="text" onkeyup="mayur( '{{$loop->index}}' )" value="{{$stocmed[0]->qntys}}"
                                                            class="form-control quantity_class" name="qnty[]" tabindex="1"
                                                            id="quantity_{{$loop->index}}"></td>
                                                            
                                                    <td><input readonly type="text" value="{{$stocmed[0]->qnty_mps_total}}"
                                                            id="total_input{{$loop->index}}" class="form-control total1_class " name="mpsqnty[]"></td>
                                                    <td><input readonly type="text" value="{{$stocmed[0]->qnty_ptr_total}}"
                                                            id="total2_input{{$loop->index}}" class="form-control  total2_class" name="ptrqnty[]">
                                                    </td>
                                                </tr> --}}
                                        @endforeach
...
var rowID = $(this).closest("tr").find("#promotorsalemedicine_id").val();
clickedRowIDs.push(rowID);

    console.log("Clicked Row IDs: " + clickedRowIDs);
    console.log("Row ID: " + rowID);
    for (var i = 0; i < clickedRowIDs.length; i++) {
        var rowID = clickedRowIDs[i];
        console.log("Row ID " + (i + 1) + ": " + rowID);

        // Perform any actions you need with the clicked IDs
    }
        ...
        $(document).ready(function() {
            ...
            $(document).on('keyup', '.quantity_class', function() {
                ...
                console.log(filteredGrandTotal2.toFixed(2));
            });
        });
    </script>
