...
@section('content')
            ...
            <div class="row">
                <div class="col-md-12 mx-auto" style="margin-top: -10%;">
                    <div class="card">
                        ...
                        <form class="row g-2" method="POST" action="{{ route('update_new_medicine_master') }}">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row g-2">
                                    ...
                                    <div class="col-md-1">
										...
										<input type="text" class="form-control" id="batchno11" placeholder="Batch No." name="batch_no">
									</div>
  ...
  success: function(result){
   ...
   console.log(result);
    ...
    let medicine11=result.medicinesecond;
    $("#medicine").val(medicine11.medicine_id);
   $("#batch_no").val(medicine11.batch_no) 
