                            ...
                            <div class="card-body">
                                ...
                                <div class="row g-2">
                                    ...
                                    <div class="col-md-1" style="margin-top:3%;">
										<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleSmallModal" style="min-height:25px"><i class="fadeIn animated bx bx-plus"></i></button>
                                    ...
                                    <div class="col-md-1" style="margin-top:3%;">
                                    <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleScrollableModal"style="min-height:35px"><i class="fadeIn animated bx bx-plus"></i></button>
                                    </div>
                                    <div class="col-md-2">
                                        <label for="inputFirstName" class="form-label">Batch No*</label>

                                        <select class="multiple-select" data-placeholder="Choose anything" name="batch_no" id="batchno11">
                                            <option value="">Select</option>
                                    ...
                                    <div class="col-md-1" style="margin-top:3%;">
                                    <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleLargeModal"style="min-height:35px"><i class="fadeIn animated bx bx-plus"></i></button>
                                </div>
                                    <div class="col-md-1">
