						...
						<div class="card">
							<div class="card-body">
								<div class="card-title d-flex align-items-center">
									...
									<h5 class="mb-0 text-primary">OTP</h5>
								</div>
								<hr>
								{{-- @if(count($errors)>0)
								...
								<form class="row g-2" method="POST" action="{{route('create_otp')}}">
									{{csrf_field()}}
									
						<div class="col-md-2"></div>
									<div class="col-md-4">
										<label for="inputFirstName" class="form-label">OTP*</label>
										<input type="number" class="form-control" id="inputFirstName" placeholder="OTP" name="otp" value="{{$data->otp}}">
									</div>
