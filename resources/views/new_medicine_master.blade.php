...
@section('content')
  ...
  tr:nth-child(3n) {
        border-bottom: 1px solid #000 !important; /* You can adjust the border style as needed */
    }
    table.dataTable {
            ...
            <div class="row">
                <div class="col-md-12 mx-auto" style="margin-top: -10%;">
                    <div class="card">
                        ...
                        <form class="row g-2" method="POST" action="{{ route('create_new_medicine_master') }}">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row g-2">
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <select class="multiple-select" data-placeholder="Choose anything" name="company"
                                            ...
                                            @foreach ($addcompanies as $add)
                                                <option value="{{ $add->id }}"  @if (Session::has('company') && Session::get('company')  == $add->id ) selected @endif>
                                                    {{ $add->Name }} </option>
                                            @endforeach
                                    ...
                                    <div class="col-md-1" style="margin-top:6.3vh;">
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <input type="text" class="form-control" id="medicine" placeholder="Medicine" name="medicine" value="">
									...
									<div class="col-md-1">
										...
										<input type="text" class="form-control" id="inputFirstName" placeholder="Quantity" name="quantity" value="0">
									</div>
 ...
 <div style="overflow-x: scroll;">
                                <table  style="width:100%; margin-top:1%;margin-bottom:6vh">
                                    <tr align="center">
                                ...
                                <div class="col-md-12" style="margin:1vh;">
                                    <div class="col-md-2" style="padding-bottom:8px; text-align: center; margin-left: 45%;">
                        ...
                        {{-- <div class="row g-2"> --}}
                                ...
                                {{-- <div class="col-md-3">
                                    <label for="inputFirstName" class="form-label">Select Company</label>
                                        ...
                                        <select class="multiple-select" data-placeholder="Choose anything" name="company" id="company1" >
                ...
                <tr> 
                 ...
                 <td>
                    ...
                    <td>{{$row->default_scheme}}</td>
                                                        ...
                                                        @if ($row->status==1)
                                                        <a href="{{route('disable_medicine',$row->newmedicinemaster_id)}}">
                                                            <button type="button" class="btn1 btn-outline-primary">Disable</button></a>
                                                        @endif
