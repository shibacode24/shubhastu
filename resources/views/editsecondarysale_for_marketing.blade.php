...
@section('content')
    ...
    <form method="POST" action="{{ route('updatesecondarysalesreport_for_marketing') }}" id="createpromotor_formid">
                                            ...
                                            <tbody>
                                                ...
                                                @foreach ($stocmed as $stocmed[0])
                                                    <tr>
                                                        ...
                                                        <td class="{{ auth()->guard('marketings')->check() ? 'hide-mps' : '' }}"><input type="number" readonly name="qntypurchase[]"
